...
public class VictoryDefeatEffectsManager : MonoBehaviour
{
    ...
    public GameObject gameManager; // Référence au GameManager du jeu
    ...
    private IEnumerator PlayVictoryEffectsCoroutine()
    {
        ...
        {
            winUI = GetComponent<GameManager>().winUI;
        }
        else
        {
            winUI = GetComponent<FruitFusionGameManager>().winUI;
        }

        if (gameManager != null && winUI != null)
        {
        ...
        {
            Debug.Log("game manager in");
            GetComponent<GameManager>().canContinueWin = true;
        }
        else if (GetComponent<FruitFusionGameManager>() != null)
        {
            Debug.Log("fusion manager in");
            GetComponent<FruitFusionGameManager>().canContinueWin = true;
        }
    ...
    private IEnumerator PlayDefeatEffectsCoroutine()
    {
        ...
        if (gameManager.GetComponent<GameManager>() != null)
        {
            gameOverUI = gameManager.GetComponent<GameManager>().gameOverUI;
        }
        else
        {
            gameOverUI = gameManager.GetComponent<FruitFusionGameManager>().gameOverUI;
        }


        // Afficher l'interface de défaite
        if (gameManager != null && gameOverUI != null)
        {
